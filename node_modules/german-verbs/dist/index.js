...
exports.getConjugation = exports.alwaysUsesSein = exports.getPartizip2 = exports.getReflexiveCase = exports.getReflexiveFormPronoun = exports.getVerbInfo = void 0;
const auxHaben = {
    PA2: ['gehabt'],
...
function getVerbInfo(verbsList, verb) {
    if (verb === 'haben')
        return auxHaben;
    if (verb === 'sein')
        return auxSein;
...
function getReflexiveFormPronoun(pronominalCase, person, number) {
...
exports.getReflexiveFormPronoun = getReflexiveFormPronoun;
// exported only to ease testing
function getReflexiveCase(verb) {
    const accList = [
        'abkühlen',
        'abheben',
        'amüsieren',
    ...
    const datList = ['denken', 'kaufen', 'anziehen'];
...
exports.getReflexiveCase = getReflexiveCase;
...
*/
function getPartizip2(verbsList, verb) {
    const verbInfo = getVerbInfo(verbsList, verb);
    const part2list = verbInfo['PA2'];
    if (!part2list) {
        const err = new Error();
        err.name = 'NotFoundInDict';
...
exports.getPartizip2 = getPartizip2;
const alwaysSein = [
    'aufwachen',
    'aufwachsen',
    'einziehen',
...
function alwaysUsesSein(verb) {
    return alwaysSein.indexOf(verb) > -1;
}
exports.alwaysUsesSein = alwaysUsesSein;
const validTenses = [
    'PRASENS',
    'PRATERITUM',
    'FUTUR1',
...
function getConjugation(verbsList, verb, tense, person, number, aux, pronominal, pronominalCase) {
    // check params
    ...
    switch (tense) {
        ...
        case 'PERFEKT':
            return [
                this.getConjugation(verbsList, aux.toLowerCase(), 'PRASENS', person, number, null, pronominal, pronominalCase).join(''),
                getPartizip2(verbsList, verb),
            ];
        case 'PLUSQUAMPERFEKT':
            return [
                this.getConjugation(verbsList, aux.toLowerCase(), 'PRATERITUM', person, number, null, pronominal, pronominalCase).join(''),
                getPartizip2(verbsList, verb),
            ];
        case 'FUTUR2':
            return [
        ...
        case 'KONJUNKTIV1_FUTUR1':
            return [
                this.getConjugation(verbsList, 'werden', 'KONJUNKTIV1_PRASENS', person, number, null, pronominal, pronominalCase).join(''),
                verb,
            ];
        case 'KONJUNKTIV1_PERFEKT':
            return [
                this.getConjugation(verbsList, aux.toLowerCase(), 'KONJUNKTIV1_PRASENS', person, number, null, pronominal, pronominalCase).join(''),
                getPartizip2(verbsList, verb),
            ];
        case 'KONJUNKTIV2_FUTUR1':
            return [
                this.getConjugation(verbsList, 'werden', 'KONJUNKTIV2_PRATERITUM', person, number, null, pronominal, pronominalCase).join(''),
                verb,
            ];
    ...
    const pronominalPronoun = pronominal ? getReflexiveFormPronoun(pronominalCase, person, number) : null;
