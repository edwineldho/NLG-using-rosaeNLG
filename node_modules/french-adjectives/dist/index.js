...
exports.agree = exports.getChangeant = void 0;
...
function getAdjFeminine(adjective) {
...
function getAdjPlural(adjective) {
    if (adjInvariables.indexOf(adjective) > -1) {
        return adjective;
    }
    const exceptions = {
...
function getChangeant(agreedAdj) {
    return adjChangeants[agreedAdj]; // most often null
}
exports.getChangeant = getChangeant;
function getBeforeNoun(agreedAdj, noun, contractsData) {
...
function agree(adjective, gender, number, noun, isBeforeNoun, contractsData) {
