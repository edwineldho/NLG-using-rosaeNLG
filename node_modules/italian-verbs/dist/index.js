...
function checkAgreeGender(agreeGender) {
...
function checkAgreeNumber(agreeNumber) {
...
function checkPersonImp(tense, number, person) {
    if (tense === 'IMPERATIVO') {
...
function checkComposedTenseOptions(composedTenseOptions) {
...
function getPastParticiple(verbInfo, agreeGender, agreeNumber) {
...
function getConjugatedAux(verbsList, aux, tense, person, number) {
    const auxTenses = {
...
function getConjugation(verbsList, verb, tense, person, number, composedTenseOptions) {
    // check params
    checkNumber(number);
    checkPerson(person);
    checkTense(tense);
    ...
    const getConjugatedFromVerbInfo = () => {
        const keys = {
            PRESENTE: ['ind', 'pres'],
            IMPERFETTO: ['ind', 'impf'],
        ...
        const modeKey = keys[tense][0];
        const tenseKey = keys[tense][1];
